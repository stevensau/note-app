...
if (Meteor.isClient) {
  describe('Editor', function () {
    ...
    it('should update note body on text change', function (){
    ...
    it('should update note title on text change', function (){
    ...
    it('should note set state if props not provided', function () {
      const wrapper = mount(<Editor browserHistory={browserHistory} call={call}/>);
